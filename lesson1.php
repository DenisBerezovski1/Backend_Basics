<?php
    ...
    $_work_experience = 'Разработка проекта малоэтажного многоквартирного жилого дома на 72 квартиры с системой подземных парковок';
    echo $_profession
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $_profession;?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jan 2015 - <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?php echo $_work_experience;?></p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $_profession;?></b></h5>
        ...
        <div class="w3-container">
          ...
          <p><?php echo $_work_experience;?></p><br>
        </div>
      </div>
